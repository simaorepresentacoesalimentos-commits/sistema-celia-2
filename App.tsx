          ...
          <div className="bg-white rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSave} className="p-6 space-y-5 max-h-[85vh] overflow-y-auto custom-scrollbar">
              ...
              <div className="space-y-1">
                ...
                <textarea className="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-2.5 font-medium text-slate-600 outline-none focus:border-indigo-500 min-h-[150px] resize-none shadow-inner text-sm" placeholder="Histórico ou observações..." value={newCustomer.anotacoes} onChange={e => setNewCustomer({...newCustomer, anotacoes: e.target.value})} />
              </div>
