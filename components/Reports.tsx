...
const Reports: React.FC = () => {
  ...
  const filteredCustomers = customers.filter(c => {
    ...
    const clientMatch = !filters.cliente || (c.name || '').toLowerCase().includes(filters.cliente.toLowerCase());
    return statusMatch && sellerMatch && clientMatch;
  });
  ...
  <label className="text-[9px] font-texto text-slate-400 uppercase mb-2 block">
    Cliente
  </label>
...
<TD Nome da Classe="PX-6 PY-4 TEXTO-[10px] Texto-Slate-600 whitespace-pre-line">
